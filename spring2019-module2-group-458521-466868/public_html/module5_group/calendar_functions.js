		...
		buttons: [
			{
				...
				click: function(){
					...
					$.ajax({
						...
						type: 'POST',
						dataType: 'json',
						data: {"event_name": $("#event_name").val(),"token":token, "event_date": $("#event_date").val(), "start_time": $("#event_start_time").val(), "end_time": $("#event_end_time").val(), "event_location": $("#event_location").val(), "event_tag": event_tag, "usersToShare":$("#usersToShare").val()}
